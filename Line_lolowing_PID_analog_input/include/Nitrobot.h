...
#define NB_MOTOR_LEFT_FWD_PIN 6    //Connected to motor controler pin IN1
#define NB_MOTOR_LEFT_BKWD_PIN 10   //Connected to motor controler pin IN2
#define NB_MOTOR_RIGHT_FWD_PIN 9    //Connected to motor controler pin IN4
#define NB_MOTOR_RIGHT_BKWD_PIN 5    //Connected to motor controler pin IN3
